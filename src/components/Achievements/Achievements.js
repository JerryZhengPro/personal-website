...
const Achievements = () => {
    const slideshow = [
        <Achievement image={AP} description="5 on 4 AP Exams"/>, 
        <Achievement image={SAT} description="800 on 2 SAT Subject Tests"/>, 
        <Achievement image={kumon} description="Kumon Math & Reading Completer"/>,
