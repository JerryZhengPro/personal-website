...
const Extracurriculars = () => {
    ...
    const descriptionB = 
        ...
        ranging from arithmetic to calculus. I currently have over 250 hours of teaching experience.`; 

    const titleC = "307 RCSCC Mariner"; 
    const descriptionC = 
        `I am currently a Petty Officer First Class in 307 RCSCC Mariner, a sea cadet corp. I lead divisions, 
        teach lessons, supervise training nights, and raise money for the Royal Canadian
